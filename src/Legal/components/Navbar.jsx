...
const Navbar = ({menu, handler}) => {
  return (
    <div className="flex justify-between items-center px-4 sm:px-10 md:px-6 py-4 md:py-7 md:sticky w-full top-0 bg-gray-900 z-[100] shadow-md shadow-slate-800">
       ...
       <div className={`absolute top-[59px] md:top-[100px] flex-col left-0 h-[94vh] gap-y-7 bg-gray-900 z-[3] py-7 px-5 border-l-2 border-slate-900 text-slate-100 flex font-semibold drop-shadow-3xl  ${menu ? 'w-[50%] opacity-100' : 'w-0  opacity-0'} transition-all duration-500 md:hidden z-[99]`}>
        <a href="#home">Home</a>
        <a href="#contact">Contact</a>
        <a href="#services">Services</a>
        <a href="#newsletter">Newsletter</a>
